                ...
                <table cellpadding="0" cellspacing="0" border="0" align="center" width="100%">
                    <tr>
                        <td style="padding: 20px; ">
                          ...
                          <h5 style="text-align: center; font-size: 20px; font-weight: 600; margin: 0; color: #134d75;">Account Under Verification</h5>
     
                        <p style="line-height: 2rem;">Your account is currently undergoing verification. We apologize for any inconvenience caused and appreciate your patience. Within 24 hours, we will notify you of the verification status on your email. Thank you for understanding.</p>
